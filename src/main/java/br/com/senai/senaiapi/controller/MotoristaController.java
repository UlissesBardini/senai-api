...
public class MotoristaController {
	...
	public ResponseEntity<?> inserir(@RequestBody Map<String, Object> motoristaMap) {
		Motorista novoMotorista = mapper.convertValue(motoristaMap, Motorista.class);
	...
	@PutMapping
	public ResponseEntity<?> alterar(@RequestBody Map<String, Object> motoristaMap) {
		Motorista motoristaSalvo = mapper.convertValue(motoristaMap, Motorista.class);
	...
	public ResponseEntity<?> listarPor(@PathVariable(name = "nome") String nome) {
		return ResponseEntity.ok(mapConverter.toJsonMap(service.listarPor(nome)));
	}
